...
public class SpectraGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class DeclElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cRegexpTestParserRuleCall_12 = (RuleCall)cAlternatives.eContents().get(12);
		...
		//RegexpTest
		public RuleCall getRegexpTestParserRuleCall_12() { return cRegexpTestParserRuleCall_12; }
	}
	...
	public class RegexpTestElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "tau.smlab.syntech.Spectra.RegexpTest");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cRegtestKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Assignment cNameAssignment_1_0 = (Assignment)cGroup_1.eContents().get(0);
		private final RuleCall cNameIDTerminalRuleCall_1_0_0 = (RuleCall)cNameAssignment_1_0.eContents().get(0);
		private final Keyword cColonKeyword_1_1 = (Keyword)cGroup_1.eContents().get(1);
		private final Alternatives cAlternatives_2 = (Alternatives)cGroup.eContents().get(2);
		private final Assignment cRegExpPointerAssignment_2_0 = (Assignment)cAlternatives_2.eContents().get(0);
		private final CrossReference cRegExpPointerDefineRegExpDeclCrossReference_2_0_0 = (CrossReference)cRegExpPointerAssignment_2_0.eContents().get(0);
		private final RuleCall cRegExpPointerDefineRegExpDeclIDTerminalRuleCall_2_0_0_1 = (RuleCall)cRegExpPointerDefineRegExpDeclCrossReference_2_0_0.eContents().get(1);
		private final Assignment cRegExpAssignment_2_1 = (Assignment)cAlternatives_2.eContents().get(1);
		private final RuleCall cRegExpRegExpParserRuleCall_2_1_0 = (RuleCall)cRegExpAssignment_2_1.eContents().get(0);
		private final RuleCall cTOK_SEMIParserRuleCall_3 = (RuleCall)cGroup.eContents().get(3);
		...
		//('regtest')
		public Keyword getRegtestKeyword_0() { return cRegtestKeyword_0; }
		...
		//((regExpPointer = [DefineRegExpDecl]) | (regExp = RegExp))
		public Alternatives getAlternatives_2() { return cAlternatives_2; }
		
		//(regExpPointer = [DefineRegExpDecl])
		public Assignment getRegExpPointerAssignment_2_0() { return cRegExpPointerAssignment_2_0; }
		
		//[DefineRegExpDecl]
		public CrossReference getRegExpPointerDefineRegExpDeclCrossReference_2_0_0() { return cRegExpPointerDefineRegExpDeclCrossReference_2_0_0; }
		
		//ID
		public RuleCall getRegExpPointerDefineRegExpDeclIDTerminalRuleCall_2_0_0_1() { return cRegExpPointerDefineRegExpDeclIDTerminalRuleCall_2_0_0_1; }
		
		//(regExp = RegExp)
		public Assignment getRegExpAssignment_2_1() { return cRegExpAssignment_2_1; }
		
		//RegExp
		public RuleCall getRegExpRegExpParserRuleCall_2_1_0() { return cRegExpRegExpParserRuleCall_2_1_0; }
	...
	private final RegexpTestElements pRegexpTest;
	...
	public SpectraGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pRegexpTest = new RegexpTestElements();
	...
	//  ('regtest') (name=ID ':')?
	//  ((regExpPointer = [DefineRegExpDecl]) | (regExp = RegExp)) TOK_SEMI;
	public RegexpTestElements getRegexpTestAccess() {
		return pRegexpTest;
	}
	
	public ParserRule getRegexpTestRule() {
		return getRegexpTestAccess().getRule();
	}
