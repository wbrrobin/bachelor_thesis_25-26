...
public class SpectraSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SpectraPackage.eINSTANCE)
			...
			case SpectraPackage.REGEXP_TEST:
				sequence_RegexpTest(context, (RegexpTest) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     Decl returns RegexpTest
	 *     RegexpTest returns RegexpTest
	 *
	 * Constraint:
	 *     (name=ID? (regExpPointer=[DefineRegExpDecl|ID] | regExp=RegExp))
	 * </pre>
	 */
	protected void sequence_RegexpTest(ISerializationContext context, RegexpTest semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
