...
public class SpectraAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected SpectraSwitch<Adapter> modelSwitch =
    new SpectraSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseRegexpTest(RegexpTest object)
      {
        return createRegexpTestAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link tau.smlab.syntech.spectra.RegexpTest <em>Regexp Test</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createRegexpTestAdapter()
  {
    return null;
  }
