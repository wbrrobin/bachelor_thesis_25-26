...
public class SpectraPackageImpl extends EPackageImpl implements SpectraPackage
{
   ...
   * @generated
   */
  private EClass regexpTestEClass = null;
   ...
   */
  @Override
  public EClass getRegexpTest()
  {
    return regexpTestEClass;
  }
   ...
   */
  @Override
  public EAttribute getRegexpTest_Name()
  {
    return (EAttribute)regexpTestEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EReference getRegexpTest_RegExpPointer()
  {
    return (EReference)regexpTestEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getRegexpTest_RegExp()
  {
    return (EReference)regexpTestEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    regexpTestEClass = createEClass(REGEXP_TEST);
    createEAttribute(regexpTestEClass, REGEXP_TEST__NAME);
    createEReference(regexpTestEClass, REGEXP_TEST__REG_EXP_POINTER);
    createEReference(regexpTestEClass, REGEXP_TEST__REG_EXP);
  ...
  public void initializePackageContents()
  {
    ...
    regexpTestEClass.getESuperTypes().add(this.getDecl());
    ...
    initEClass(regexpTestEClass, RegexpTest.class, "RegexpTest", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getRegexpTest_Name(), ecorePackage.getEString(), "name", null, 0, 1, RegexpTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRegexpTest_RegExpPointer(), this.getDefineRegExpDecl(), null, "regExpPointer", null, 0, 1, RegexpTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRegexpTest_RegExp(), this.getRegExp(), null, "regExp", null, 0, 1, RegexpTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
