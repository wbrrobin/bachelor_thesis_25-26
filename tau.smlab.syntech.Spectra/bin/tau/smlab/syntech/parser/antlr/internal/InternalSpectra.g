...
@after {
	...
	(
		...
		{
			$current = $this_RegexpTest_12.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleRegexpTest returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getRegexpTestRule()); }
	iv_ruleRegexpTest=ruleRegexpTest
	{ $current=$iv_ruleRegexpTest.current; }
	EOF;

// Rule RegexpTest
ruleRegexpTest returns [EObject current=null]
@init {
	enterRule();
}
@after {
