...
public class SpectraParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SpectraGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRegexpTestAccess().getAlternatives_2(), "rule__RegexpTest__Alternatives_2");
			...
			builder.put(grammarAccess.getRegexpTestAccess().getGroup(), "rule__RegexpTest__Group__0");
			builder.put(grammarAccess.getRegexpTestAccess().getGroup_1(), "rule__RegexpTest__Group_1__0");
			...
			builder.put(grammarAccess.getRegexpTestAccess().getNameAssignment_1_0(), "rule__RegexpTest__NameAssignment_1_0");
			builder.put(grammarAccess.getRegexpTestAccess().getRegExpPointerAssignment_2_0(), "rule__RegexpTest__RegExpPointerAssignment_2_0");
			builder.put(grammarAccess.getRegexpTestAccess().getRegExpAssignment_2_1(), "rule__RegexpTest__RegExpAssignment_2_1");
